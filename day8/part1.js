...
1 to 2, jmp -4 executes, setting the next instruction to the only acc +3. It sets the accumulator to 5, 
...
console.log(part1(testInput, acc));
console.log(part1(input, acc));

module.exports = { input, testInput, part1 };
